...
func (s *Ethereum) Stop() error {
	...
	s.miner.Stop()
	s.miner.Close()
	// TODO this is a hotfix for https://github.com/gregpr07/bsc/issues/22892, need a better solution
